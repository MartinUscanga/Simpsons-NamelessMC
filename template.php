...
class Simpsons_Template extends SmartyTemplateBase
{
    ...
    {
        $template = [
            'name' => 'Simpsons-NamelessMC-main',
            'version' => '2.0.0',
            'nl_version' => '2.2.0',
            'author' => '<a href="https://github.com/MartinUscanga" target="_blank">MartinUscanga</a>',
        ];
 ...
 * @var Pages    $pages
 */
$template = new Simpsons_Template($cache, $language, $user, $pages);
